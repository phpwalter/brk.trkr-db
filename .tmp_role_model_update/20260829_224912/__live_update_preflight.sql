...
===============================================================================
 ...
 The functions below preserve the interface expected by the 1100_security SQL files
 while treating declared installer dependencies as already satisfied.

 Real live prerequisites are checked by apply_role_model_update_v5.ps1 before
 this session starts.
===============================================================================
*/
