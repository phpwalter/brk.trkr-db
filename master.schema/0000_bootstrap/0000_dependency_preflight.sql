...
VALUES
    ...
    (92, '1000_function/1000_identity_function.sql', ARRAY['identity.users', 'identity.families', 'identity.family_memberships', 'identity.family_member_permissions', 'identity.guardianships', 'identity.owners']::text[]),
    (93, '1000_function/1001_hierarchy_function.sql', ARRAY['reference.themes', 'reference.categories', 'collection.storage_locations', 'moc.subassemblies']::text[]),
    (94, '1000_function/1002_catalog_function.sql', ARRAY['Complete 0300_catalog domain']::text[]),
    (95, '1000_function/1003_definition_function.sql', ARRAY['definition.inventory_definitions', 'definition.inventory_versions', 'definition.requirement_groups', 'definition.requirement_options', 'definition.definition_authority']::text[]),
    (96, '1000_function/1004_collection_function.sql', ARRAY['collection.entries', 'collection.instances', 'collection.storage_locations', 'collection.storage_allocations', 'wanted.build_allocations']::text[]),
    (97, '1000_function/1005_wanted_function.sql', ARRAY['wanted.build_goals', 'definition.requirement_groups', 'definition.requirement_options', 'collection.explicit_part_balance()']::text[]),
    (98, '1000_function/1006_moc_function.sql', ARRAY['moc.mocs', 'moc.revisions', 'moc.forks']::text[]),
    (99, '1000_function/1007_import_function.sql', ARRAY['import.source_runs', 'import.source_run_datasets', 'import.source_stage_records', 'catalog.source_values', 'catalog.source_value_history', 'definition.inventory_versions', 'reference.external_sources']::text[]),
    (100, '1000_function/1008_audit_function.sql', ARRAY['audit.events', 'audit.changes', 'identity.current_user_id()', 'Complete 0500_collections domain', 'Complete 0600_wanted domain', 'Complete 0700_mocs domain', 'Complete 0800_imports domain']::text[]),
    (101, '1000_function/1009_integrity_hardening.sql', ARRAY['identity.users', 'identity.families', 'identity.guardianships', 'reference.themes', 'reference.categories', 'collection.storage_locations', 'collection.entries', 'collection.instances', 'collection.storage_allocations', 'collection.acquisition_items', 'wanted.wishlist_entries', 'wanted.build_goals', 'wanted.build_allocations', 'moc.revisions', 'moc.subassemblies', 'moc.forks', 'import.normalized_records', 'definition.definition_authority']::text[]),
    (102, '1000_function/1010_moc_access_function.sql', ARRAY['api schema', 'moc.mocs', 'moc.revisions', 'moc.assets', 'moc.licenses', 'moc.subassemblies', 'identity.current_user_id()']::text[]),
    (103, '1000_function/1011_request_context.sql', ARRAY['app schema', 'identity.current_user_id()', 'audit.events']::text[]),
    (104, '1000_function/1012_graph_function.sql', ARRAY['definition.manifest_subassemblies']::text[]),
    ...
    (106, '1000_function/1014_finance_function.sql', ARRAY['finance.accounts', 'finance.transactions', 'finance.ledger_entries', 'finance.source_events', 'pgcrypto']::text[]),
    (107, '1000_function/1015_rebrickable_reference_reconcile.sql', ARRAY['1000_function/1007_import_function.sql', 'reference.external_sources', 'reference.external_color_mappings', 'reference.external_theme_mappings', 'reference.external_category_mappings', 'reference.colors', 'reference.themes', 'reference.categories']::text[]),
    (108, '1000_function/1016_rebrickable_catalog_reconcile.sql', ARRAY['1000_function/1007_import_function.sql', 'catalog.items', 'catalog.parts', 'catalog.sets', 'catalog.minifigures', 'catalog.external_identifiers', 'catalog.source_values', 'catalog.source_value_history', 'reference.external_theme_mappings', 'reference.external_category_mappings', 'app.set_import_context(uuid)', 'reference.external_color_mappings', 'catalog.part_variants', 'catalog.lego_elements', '0300_catalog/0320_catalog_search_media.sql', '0800_imports/0802_raw_staging.sql']::text[]),
    (109, '1200_validation/1210_function_validation.sql', ARRAY['Complete 1000_function domain']::text[]),
    (110, '1050_reporting/1050_reporting_views.sql', ARRAY['catalog.items', 'collection.entries', 'collection.instances', 'wanted.wishlist_entries', 'moc.mocs', 'moc.revisions', 'import.jobs', 'marketplace.listings', 'marketplace.orders', 'finance.transactions', 'operations.notifications']::text[]),
    (111, '1100_security/1100_roles.sql', ARRAY['PostgreSQL role-creation privileges']::text[]),
    (112, '1100_security/1101_rls_identity.sql', ARRAY['identity.user_credentials', 'identity.user_sessions', 'identity.one_time_tokens', 'identity.current_user_id()', 'identity.can_manage_user()']::text[]),
    (113, '1100_security/1102_rls_collections.sql', ARRAY['Complete 0500_collections domain', 'identity.current_user_id()', 'identity.can_view_owner()', 'identity.can_manage_owner()']::text[]),
    (114, '1100_security/1103_rls_wanted.sql', ARRAY['Complete 0600_wanted domain', 'identity.current_user_id()', 'identity.can_view_owner()', 'identity.can_manage_owner()']::text[]),
    (115, '1100_security/1104_rls_mocs.sql', ARRAY['Complete 0700_mocs domain', 'identity.current_user_id()', 'identity.can_view_owner()', 'identity.can_manage_owner()']::text[]),
    (116, '1100_security/1105_rls_imports.sql', ARRAY['Complete 0800_imports domain', 'identity.current_user_id()', 'identity.can_view_owner()', 'identity.can_manage_owner()']::text[]),
    (117, '1100_security/1106_rls_audit.sql', ARRAY['1100_security/1100_roles.sql', 'audit.events', 'audit.changes']::text[]),
    (118, '1100_security/1108_rls_catalog_definition.sql', ARRAY['Complete 0300_catalog domain', 'Complete 0400_definitions domain', 'identity.current_user_id()', 'identity.can_view_owner()']::text[]),
    (119, '1100_security/1109_rls_extended.sql', ARRAY['marketplace.listings', 'marketplace.orders', 'operations.notifications', 'identity.current_user_id()', 'identity.can_view_owner()', 'identity.can_manage_owner()']::text[]),
    (120, '1100_security/1107_grants.sql', ARRAY['1100_security/1100_roles.sql', '1100_security/1101_rls_identity.sql', '1100_security/1102_rls_collections.sql', '1100_security/1103_rls_wanted.sql', '1100_security/1104_rls_mocs.sql', '1100_security/1105_rls_imports.sql', '1100_security/1106_rls_audit.sql']::text[]),
    (121, '1100_security/1110_api_surface_lockdown.sql', ARRAY['1100_security/1107_grants.sql', 'Complete 1000_function domain']::text[]),
    (122, '1100_security/1111_role_ownership_separation.sql', ARRAY['1100_security/1100_roles.sql', '1100_security/1110_api_surface_lockdown.sql']::text[]),
    (123, '1200_validation/1211_security_validation.sql', ARRAY['Complete 1100_security domain']::text[]),
    (124, '1200_validation/1212_integrity_validation.sql', ARRAY['1000_function/1009_integrity_hardening.sql', '1100_security/1108_rls_catalog_definition.sql']::text[]),
    (125, '1200_validation/1214_extended_architecture_validation.sql', ARRAY['catalog.part_molds', 'catalog.item_search', 'definition.manifest_subassemblies', 'definition.minifig_compositions', 'marketplace.listings', 'finance.transactions', 'operations.notifications', 'reporting.catalog_items', 'api.search_catalog()', 'admin.post_financial_transaction()', '1100_security/1107_grants.sql']::text[]),
    (126, '1200_validation/1215_security_contract_validation.sql', ARRAY['1100_security/1107_grants.sql', '1100_security/1110_api_surface_lockdown.sql', 'Complete 1000_function domain']::text[]),
    (127, '1200_validation/1216_adversarial_authorization_validation.sql', ARRAY['1200_validation/1215_security_contract_validation.sql', 'identity.current_user_id()', 'identity.can_manage_user()', 'identity.has_family_capability()', 'api.mark_notification_read(uuid)']::text[]),
    (128, '1200_validation/1217_pgbouncer_transaction_context_validation.sql', ARRAY['1200_validation/1216_adversarial_authorization_validation.sql', 'app.set_authenticated_user(uuid)', 'app.set_request_context(uuid,text,text)', 'app.set_import_context(uuid)', 'identity.current_user_id()', 'identity.current_user_id_optional()']::text[]),
    (129, '1200_validation/1218_api_surface_validation.sql', ARRAY['1100_security/1110_api_surface_lockdown.sql', '1200_validation/1217_pgbouncer_transaction_context_validation.sql']::text[]),
    (130, '1200_validation/1219_migration_framework_validation.sql', ARRAY['0000_bootstrap/0005_migration_framework.sql', '1100_security/1107_grants.sql']::text[]),
    (131, '1200_validation/1220_financial_readiness_validation.sql', ARRAY['0760_finance/0761_financial_readiness_anchors.sql', '1000_function/1014_finance_function.sql', '1100_security/1107_grants.sql', '1200_validation/1219_migration_framework_validation.sql']::text[]),
    (132, '1200_validation/1221_operational_integrity_validation.sql', ARRAY['1200_validation/1220_financial_readiness_validation.sql']::text[]),
    (133, '1200_validation/1222_role_separation_validation.sql', ARRAY['1100_security/1111_role_ownership_separation.sql', '1200_validation/1221_operational_integrity_validation.sql']::text[]),
    (134, '1200_validation/1213_dependency_validation.sql', ARRAY['1200_validation/1212_integrity_validation.sql', '1200_validation/1214_extended_architecture_validation.sql', '1200_validation/1215_security_contract_validation.sql', '1200_validation/1216_adversarial_authorization_validation.sql', '1200_validation/1217_pgbouncer_transaction_context_validation.sql', '1200_validation/1218_api_surface_validation.sql', '1200_validation/1219_migration_framework_validation.sql', '1200_validation/1220_financial_readiness_validation.sql', '1200_validation/1221_operational_integrity_validation.sql', '1200_validation/1222_role_separation_validation.sql']::text[]);
