...
VALUES
    ...
    (131, '1100_security/1112_admin_execute_only.sql', ARRAY['5000_function/5100_admin/5100_admin_common.sql', '5000_function/5100_admin/5110_admin_catalog_lifecycle.sql', '1100_security/1111_role_ownership_separation.sql']::text[]),
    (132, '1200_validation/1211_security_validation.sql', ARRAY['Complete 1100_security domain']::text[]),
    (133, '1200_validation/1212_integrity_validation.sql', ARRAY['5000_function/5700_system/5708_system_integrity_hardening.sql', '1100_security/1108_rls_catalog_definition.sql']::text[]),
    ...
    (135, '1200_validation/1215_security_contract_validation.sql', ARRAY['1100_security/1107_grants.sql', '1100_security/1110_api_surface_lockdown.sql', '5000_function/5700_system/5700_system_identity.sql', '5000_function/5700_system/5701_system_hierarchy.sql', '5000_function/5700_system/5702_system_catalog.sql', '5000_function/5700_system/5703_system_definition.sql', '5000_function/5700_system/5704_system_collection.sql', '5000_function/5700_system/5705_system_wanted.sql', '5000_function/5700_system/5706_system_moc.sql', '5000_function/5000_importer/5000_importer_common.sql', '5000_function/5700_system/5707_system_audit.sql', '5000_function/5700_system/5708_system_integrity_hardening.sql', '5000_function/5200_api/5200_api_moc_access.sql', '5000_function/5700_system/5709_system_request_context.sql', '5000_function/5100_admin/5120_admin_definition_graph.sql', '5000_function/5200_api/5210_api_operational.sql', '5000_function/5100_admin/5130_admin_finance.sql', '5000_function/5000_importer/5010_importer_rebrickable_reference_reconcile.sql', '5000_function/5000_importer/5011_importer_rebrickable_catalog_reconcile.sql', '5000_function/5000_importer/5012_importer_fail_source_run.sql', '5000_function/5100_admin/5100_admin_common.sql', '5000_function/5100_admin/5110_admin_catalog_lifecycle.sql']::text[]),
    (136, '1200_validation/1216_adversarial_authorization_validation.sql', ARRAY['1200_validation/1215_security_contract_validation.sql', 'identity.current_user_id()', 'identity.can_manage_user()', 'identity.has_family_capability()', 'api.mark_notification_read(uuid)']::text[]),
    (137, '1200_validation/1217_pgbouncer_transaction_context_validation.sql', ARRAY['1200_validation/1216_adversarial_authorization_validation.sql', 'app.set_authenticated_user(uuid)', 'app.set_request_context(uuid,text,text)', 'app.set_import_context(uuid)', 'identity.current_user_id()', 'identity.current_user_id_optional()']::text[]),
    (138, '1200_validation/1218_api_surface_validation.sql', ARRAY['1100_security/1110_api_surface_lockdown.sql', '1200_validation/1217_pgbouncer_transaction_context_validation.sql']::text[]),
    (139, '1200_validation/1219_migration_framework_validation.sql', ARRAY['0000_bootstrap/0005_migration_framework.sql', '1100_security/1107_grants.sql']::text[]),
    (140, '1200_validation/1220_financial_readiness_validation.sql', ARRAY['0760_finance/0761_financial_readiness_anchors.sql', '5000_function/5100_admin/5130_admin_finance.sql', '1100_security/1107_grants.sql', '1200_validation/1219_migration_framework_validation.sql']::text[]),
    (141, '1200_validation/1221_operational_integrity_validation.sql', ARRAY['1200_validation/1220_financial_readiness_validation.sql']::text[]),
    (142, '1200_validation/1222_role_separation_validation.sql', ARRAY['1100_security/1111_role_ownership_separation.sql', '1200_validation/1221_operational_integrity_validation.sql']::text[]),
    (143, '1200_validation/1223_admin_catalog_lifecycle_validation.sql', ARRAY['1100_security/1112_admin_execute_only.sql', '1200_validation/1222_role_separation_validation.sql']::text[]),
    (144, '1200_validation/1224_system_summary_validation.sql', ARRAY['1000_reporting/1010_reporting_system_summary.sql']::text[]),
    (145, '1200_validation/1225_aggregate_tables_validation.sql', ARRAY['1000_reporting/1011_reporting_aggregate_tables.sql', '1200_validation/1224_system_summary_validation.sql']::text[]),
    (146, '1200_validation/1226_set_manifest_enrichment_validation.sql', ARRAY['0400_definitions/0410_set_manifest_components.sql', '5000_function/5000_importer/5030_importer_set_manifest_enrichment.sql', '5000_function/5400_reporting/5410_reporting_set_manifest_enrichment.sql', '1100_security/1111_role_ownership_separation.sql']::text[]),
    (147, '5000_function/5900_tests/5900_test_importer_common.sql', ARRAY['5000_function/5000_importer/5000_importer_common.sql']::text[]),
    (148, '5000_function/5900_tests/5901_test_rebrickable_reference_reconcile.sql', ARRAY['5000_function/5000_importer/5010_importer_rebrickable_reference_reconcile.sql']::text[]),
    (149, '5000_function/5900_tests/5902_test_rebrickable_catalog_reconcile.sql', ARRAY['5000_function/5000_importer/5011_importer_rebrickable_catalog_reconcile.sql']::text[]),
    (150, '5000_function/5900_tests/5903_test_fail_source_run.sql', ARRAY['5000_function/5000_importer/5012_importer_fail_source_run.sql']::text[]),
    (151, '5000_function/5900_tests/5904_test_set_manifest_enrichment.sql', ARRAY['5000_function/5000_importer/5030_importer_set_manifest_enrichment.sql', '5000_function/5400_reporting/5410_reporting_set_manifest_enrichment.sql', '1200_validation/1226_set_manifest_enrichment_validation.sql']::text[]),
    (152, '5000_function/5900_tests/5910_test_admin_common.sql', ARRAY['5000_function/5100_admin/5100_admin_common.sql', '1100_security/1112_admin_execute_only.sql']::text[]),
    (153, '5000_function/5900_tests/5911_test_admin_catalog_lifecycle.sql', ARRAY['5000_function/5100_admin/5110_admin_catalog_lifecycle.sql', '1100_security/1112_admin_execute_only.sql', '5000_function/5900_tests/5910_test_admin_common.sql']::text[]),
    (154, '5000_function/5900_tests/5912_test_admin_definition_graph.sql', ARRAY['5000_function/5100_admin/5120_admin_definition_graph.sql']::text[]),
    (155, '5000_function/5900_tests/5913_test_admin_finance.sql', ARRAY['5000_function/5100_admin/5130_admin_finance.sql']::text[]),
    (156, '5000_function/5900_tests/5920_test_api_moc_access.sql', ARRAY['5000_function/5200_api/5200_api_moc_access.sql']::text[]),
    (157, '5000_function/5900_tests/5921_test_api_operational.sql', ARRAY['5000_function/5200_api/5210_api_operational.sql']::text[]),
    (158, '5000_function/5900_tests/5970_test_system_identity.sql', ARRAY['5000_function/5700_system/5700_system_identity.sql']::text[]),
    (159, '5000_function/5900_tests/5971_test_system_hierarchy.sql', ARRAY['5000_function/5700_system/5701_system_hierarchy.sql']::text[]),
    (160, '5000_function/5900_tests/5972_test_system_catalog.sql', ARRAY['5000_function/5700_system/5702_system_catalog.sql']::text[]),
    (161, '5000_function/5900_tests/5973_test_system_definition.sql', ARRAY['5000_function/5700_system/5703_system_definition.sql']::text[]),
    (162, '5000_function/5900_tests/5974_test_system_collection.sql', ARRAY['5000_function/5700_system/5704_system_collection.sql']::text[]),
    (163, '5000_function/5900_tests/5975_test_system_wanted.sql', ARRAY['5000_function/5700_system/5705_system_wanted.sql']::text[]),
    (164, '5000_function/5900_tests/5976_test_system_moc.sql', ARRAY['5000_function/5700_system/5706_system_moc.sql']::text[]),
    (165, '5000_function/5900_tests/5977_test_system_audit.sql', ARRAY['5000_function/5700_system/5707_system_audit.sql']::text[]),
    (166, '5000_function/5900_tests/5978_test_system_integrity.sql', ARRAY['5000_function/5700_system/5708_system_integrity_hardening.sql']::text[]),
    (167, '5000_function/5900_tests/5979_test_system_request_context.sql', ARRAY['5000_function/5700_system/5709_system_request_context.sql']::text[]),
    (168, '5000_function/5900_tests/5980_test_system_summary.sql', ARRAY['1000_reporting/1010_reporting_system_summary.sql']::text[]),
    (169, '5000_function/5900_tests/5981_test_aggregate_tables.sql', ARRAY['1000_reporting/1011_reporting_aggregate_tables.sql', '5000_function/5900_tests/5980_test_system_summary.sql']::text[]),
    (170, '1200_validation/1213_dependency_validation.sql', ARRAY['1200_validation/1212_integrity_validation.sql', '1200_validation/1214_extended_architecture_validation.sql', '1200_validation/1215_security_contract_validation.sql', '1200_validation/1216_adversarial_authorization_validation.sql', '1200_validation/1217_pgbouncer_transaction_context_validation.sql', '1200_validation/1218_api_surface_validation.sql', '1200_validation/1219_migration_framework_validation.sql', '1200_validation/1220_financial_readiness_validation.sql', '1200_validation/1221_operational_integrity_validation.sql', '1200_validation/1222_role_separation_validation.sql', '1200_validation/1223_admin_catalog_lifecycle_validation.sql', '1200_validation/1224_system_summary_validation.sql', '1200_validation/1225_aggregate_tables_validation.sql', '1200_validation/1226_set_manifest_enrichment_validation.sql', '5000_function/5900_tests/5900_test_importer_common.sql', '5000_function/5900_tests/5901_test_rebrickable_reference_reconcile.sql', '5000_function/5900_tests/5902_test_rebrickable_catalog_reconcile.sql', '5000_function/5900_tests/5903_test_fail_source_run.sql', '5000_function/5900_tests/5904_test_set_manifest_enrichment.sql', '5000_function/5900_tests/5910_test_admin_common.sql', '5000_function/5900_tests/5911_test_admin_catalog_lifecycle.sql', '5000_function/5900_tests/5912_test_admin_definition_graph.sql', '5000_function/5900_tests/5913_test_admin_finance.sql', '5000_function/5900_tests/5920_test_api_moc_access.sql', '5000_function/5900_tests/5921_test_api_operational.sql', '5000_function/5900_tests/5970_test_system_identity.sql', '5000_function/5900_tests/5971_test_system_hierarchy.sql', '5000_function/5900_tests/5972_test_system_catalog.sql', '5000_function/5900_tests/5973_test_system_definition.sql', '5000_function/5900_tests/5974_test_system_collection.sql', '5000_function/5900_tests/5975_test_system_wanted.sql', '5000_function/5900_tests/5976_test_system_moc.sql', '5000_function/5900_tests/5977_test_system_audit.sql', '5000_function/5900_tests/5978_test_system_integrity.sql', '5000_function/5900_tests/5979_test_system_request_context.sql', '5000_function/5900_tests/5980_test_system_summary.sql', '5000_function/5900_tests/5981_test_aggregate_tables.sql']::text[]);
