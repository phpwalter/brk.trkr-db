...
VALUES
    ...
    (107, '1200_validation/1210_function_validation.sql', ARRAY['Complete 1000_function domain']::text[]),
    (108, '1050_reporting/1050_reporting_views.sql', ARRAY['catalog.items', 'collection.entries', 'collection.instances', 'wanted.wishlist_entries', 'moc.mocs', 'moc.revisions', 'import.jobs', 'marketplace.listings', 'marketplace.orders', 'finance.transactions', 'operations.notifications']::text[]),
    (109, '1100_security/1100_roles.sql', ARRAY['PostgreSQL role-creation privileges']::text[]),
    (110, '1100_security/1101_rls_identity.sql', ARRAY['identity.user_credentials', 'identity.user_sessions', 'identity.one_time_tokens', 'identity.current_user_id()', 'identity.can_manage_user()']::text[]),
    (111, '1100_security/1102_rls_collections.sql', ARRAY['Complete 0500_collections domain', 'identity.current_user_id()', 'identity.can_view_owner()', 'identity.can_manage_owner()']::text[]),
    (112, '1100_security/1103_rls_wanted.sql', ARRAY['Complete 0600_wanted domain', 'identity.current_user_id()', 'identity.can_view_owner()', 'identity.can_manage_owner()']::text[]),
    (113, '1100_security/1104_rls_mocs.sql', ARRAY['Complete 0700_mocs domain', 'identity.current_user_id()', 'identity.can_view_owner()', 'identity.can_manage_owner()']::text[]),
    (114, '1100_security/1105_rls_imports.sql', ARRAY['Complete 0800_imports domain', 'identity.current_user_id()', 'identity.can_view_owner()', 'identity.can_manage_owner()']::text[]),
    (115, '1100_security/1106_rls_audit.sql', ARRAY['1100_security/1100_roles.sql', 'audit.events', 'audit.changes']::text[]),
    (116, '1100_security/1108_rls_catalog_definition.sql', ARRAY['Complete 0300_catalog domain', 'Complete 0400_definitions domain', 'identity.current_user_id()', 'identity.can_view_owner()']::text[]),
    (117, '1100_security/1109_rls_extended.sql', ARRAY['marketplace.listings', 'marketplace.orders', 'operations.notifications', 'identity.current_user_id()', 'identity.can_view_owner()', 'identity.can_manage_owner()']::text[]),
    (118, '1100_security/1107_grants.sql', ARRAY['1100_security/1100_roles.sql', '1100_security/1101_rls_identity.sql', '1100_security/1102_rls_collections.sql', '1100_security/1103_rls_wanted.sql', '1100_security/1104_rls_mocs.sql', '1100_security/1105_rls_imports.sql', '1100_security/1106_rls_audit.sql']::text[]),
    (119, '1100_security/1110_api_surface_lockdown.sql', ARRAY['1100_security/1107_grants.sql', 'Complete 1000_function domain']::text[]),
    (120, '1100_security/1111_role_ownership_separation.sql', ARRAY['1100_security/1100_roles.sql', '1100_security/1110_api_surface_lockdown.sql']::text[]),
    (121, '1200_validation/1211_security_validation.sql', ARRAY['Complete 1100_security domain']::text[]),
    (122, '1200_validation/1212_integrity_validation.sql', ARRAY['1000_function/1009_integrity_hardening.sql', '1100_security/1108_rls_catalog_definition.sql']::text[]),
    ...
    (124, '1200_validation/1215_security_contract_validation.sql', ARRAY['1100_security/1107_grants.sql', '1100_security/1110_api_surface_lockdown.sql', 'Complete 1000_function domain']::text[]),
    (125, '1200_validation/1216_adversarial_authorization_validation.sql', ARRAY['1200_validation/1215_security_contract_validation.sql', 'identity.current_user_id()', 'identity.can_manage_user()', 'identity.has_family_capability()', 'api.mark_notification_read(uuid)']::text[]),
    (126, '1200_validation/1217_pgbouncer_transaction_context_validation.sql', ARRAY['1200_validation/1216_adversarial_authorization_validation.sql', 'app.set_authenticated_user(uuid)', 'app.set_request_context(uuid,text,text)', 'identity.current_user_id()', 'identity.current_user_id_optional()']::text[]),
    (127, '1200_validation/1218_api_surface_validation.sql', ARRAY['1100_security/1110_api_surface_lockdown.sql', '1200_validation/1217_pgbouncer_transaction_context_validation.sql']::text[]),
    (128, '1200_validation/1219_migration_framework_validation.sql', ARRAY['0000_bootstrap/0005_migration_framework.sql', '1100_security/1107_grants.sql']::text[]),
    (129, '1200_validation/1220_financial_readiness_validation.sql', ARRAY['0760_finance/0761_financial_readiness_anchors.sql', '1000_function/1014_finance_function.sql', '1100_security/1107_grants.sql', '1200_validation/1219_migration_framework_validation.sql']::text[]),
    (130, '1200_validation/1221_operational_integrity_validation.sql', ARRAY['1200_validation/1220_financial_readiness_validation.sql']::text[]),
    (131, '1200_validation/1222_role_separation_validation.sql', ARRAY['1100_security/1111_role_ownership_separation.sql', '1200_validation/1221_operational_integrity_validation.sql']::text[]),
    (132, '1200_validation/1213_dependency_validation.sql', ARRAY['1200_validation/1212_integrity_validation.sql', '1200_validation/1214_extended_architecture_validation.sql', '1200_validation/1215_security_contract_validation.sql', '1200_validation/1216_adversarial_authorization_validation.sql', '1200_validation/1217_pgbouncer_transaction_context_validation.sql', '1200_validation/1218_api_surface_validation.sql', '1200_validation/1219_migration_framework_validation.sql', '1200_validation/1220_financial_readiness_validation.sql', '1200_validation/1221_operational_integrity_validation.sql', '1200_validation/1222_role_separation_validation.sql']::text[]);
