/*
===============================================================================
 File:           1050_reporting/1050_reporting_views.sql
...
SELECT pg_temp.bt_preflight('1050_reporting/1050_reporting_views.sql', ARRAY['catalog.items', 'collection.entries', 'collection.instances', 'wanted.wishlist_entries', 'moc.mocs', 'moc.revisions', 'import.jobs', 'marketplace.listings', 'marketplace.orders', 'finance.transactions', 'operations.notifications']::text[]);
...
GROUP BY user_id;
SELECT pg_temp.bt_mark_completed('1050_reporting/1050_reporting_views.sql');
