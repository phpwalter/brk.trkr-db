/*
===============================================================================
 File:           5000_function/5700_system/5704_system_collection.sql
...
SELECT pg_temp.bt_preflight('5000_function/5700_system/5704_system_collection.sql', ARRAY['collection.entries', 'collection.instances', 'collection.storage_locations', 'collection.storage_allocations', 'wanted.build_allocations']::text[]);
...
SELECT pg_temp.bt_mark_completed('5000_function/5700_system/5704_system_collection.sql');
