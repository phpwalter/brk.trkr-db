/*
===============================================================================
 File:           5000_function/5000_importer/5000_importer_common.sql
...
SELECT pg_temp.bt_preflight('5000_function/5000_importer/5000_importer_common.sql', ARRAY['import.source_runs', 'import.source_run_datasets', 'import.source_stage_records', 'catalog.source_values', 'catalog.source_value_history', 'definition.inventory_versions', 'reference.external_sources']::text[]);
...
SELECT pg_temp.bt_mark_completed('5000_function/5000_importer/5000_importer_common.sql');
