/*
===============================================================================
 File:           1000_function/1006_moc_function.sql
...
SELECT pg_temp.bt_preflight('1000_function/1006_moc_function.sql', ARRAY['moc.mocs', 'moc.revisions', 'moc.forks']::text[]);
...
SELECT pg_temp.bt_mark_completed('1000_function/1006_moc_function.sql');
