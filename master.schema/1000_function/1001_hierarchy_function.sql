/*
===============================================================================
 File:           1000_function/1001_hierarchy_function.sql
...
SELECT pg_temp.bt_preflight('1000_function/1001_hierarchy_function.sql', ARRAY['reference.themes', 'reference.categories', 'collection.storage_locations', 'moc.subassemblies']::text[]);
...
SELECT pg_temp.bt_mark_completed('1000_function/1001_hierarchy_function.sql');
