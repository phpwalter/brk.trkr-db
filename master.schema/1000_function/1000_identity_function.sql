/*
===============================================================================
 File:           1000_function/1000_identity_function.sql
...
SELECT pg_temp.bt_preflight('1000_function/1000_identity_function.sql', ARRAY['identity.users', 'identity.families', 'identity.family_memberships', 'identity.family_member_permissions', 'identity.guardianships', 'identity.owners']::text[]);
...
SELECT pg_temp.bt_mark_completed('1000_function/1000_identity_function.sql');
