/*
===============================================================================
 File:           1000_function/1015_rebrickable_reference_reconcile.sql
 Project:        BrickTrackr
 PostgreSQL:     16+
...
SELECT pg_temp.bt_preflight('1000_function/1015_rebrickable_reference_reconcile.sql', ARRAY['1000_function/1007_import_function.sql', 'reference.external_sources', 'reference.external_color_mappings', 'reference.external_theme_mappings', 'reference.external_category_mappings', 'reference.colors', 'reference.themes', 'reference.categories']::text[]);
...
SELECT pg_temp.bt_mark_completed('1000_function/1015_rebrickable_reference_reconcile.sql');
