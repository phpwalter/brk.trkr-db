/*
===============================================================================
 File:           1000_function/1014_finance_function.sql
...
SELECT pg_temp.bt_preflight('1000_function/1014_finance_function.sql', ARRAY['finance.accounts', 'finance.transactions', 'finance.ledger_entries', 'finance.source_events', 'pgcrypto']::text[]);
...
FOR EACH ROW EXECUTE FUNCTION finance.trg_prevent_ledger_mutation();
SELECT pg_temp.bt_mark_completed('1000_function/1014_finance_function.sql');
