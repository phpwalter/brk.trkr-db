/*
===============================================================================
 File:           1000_function/1012_graph_function.sql
...
SELECT pg_temp.bt_preflight('1000_function/1012_graph_function.sql', ARRAY['definition.manifest_subassemblies']::text[]);
...
END;
$$;
SELECT pg_temp.bt_mark_completed('1000_function/1012_graph_function.sql');
