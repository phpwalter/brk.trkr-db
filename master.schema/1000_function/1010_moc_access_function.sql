/*
===============================================================================
 File:           1000_function/1010_moc_access_function.sql
...
SELECT pg_temp.bt_preflight('1000_function/1010_moc_access_function.sql', ARRAY['api schema', 'moc.mocs', 'moc.revisions', 'moc.assets', 'moc.licenses', 'moc.subassemblies', 'identity.current_user_id()']::text[]);
...
SELECT pg_temp.bt_mark_completed('1000_function/1010_moc_access_function.sql');
