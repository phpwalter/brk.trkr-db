param(
    [string]$SourceRunId = "01a02e65-b610-7d42-8e5e-87828deda6be",
...
$PythonScript = Join-Path $ScriptDir "reconcile_rebrickable_phase6b_relationships.py"
...
$LogFile = Join-Path $LogDir "rebrickable_phase6b_$Timestamp.log"
