...
$PythonScript = Join-Path $ScriptDir "reconcile_rebrickable_phase4b_checkpointed.py"
...
Write-Host "==============================================================================="
Write-Host " BrickTrackr Rebrickable Phase 4B - Checkpointed Reconcile v4.1.0"
Write-Host "==============================================================================="
...
if ($SourceRunId) {
    ...
    Write-Host "[INFO] Source run: latest validated Phase 4A elements run"
}
Write-Host ""
...
$LogFile = Join-Path $LogDir "rebrickable_phase4b_$Timestamp.log"
...
Write-Host ""
if ($ExitCode -eq 0) {
    Write-Host "[PASS] Phase 4B completed successfully." -ForegroundColor Green
}
elseif ($ExitCode -eq 130) {
    Write-Host "[STOP] Phase 4B interrupted; resume is available." -ForegroundColor Yellow
}
else {
    Write-Host "[FAIL] Phase 4B failed; resume is available after correction." -ForegroundColor Red
}
